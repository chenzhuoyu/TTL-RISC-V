...
OP('CSRRWI' , 0, X, X, 0b101, 0b11100, REG_WE | OPIMM | CSR_EN | CSR_IMM)
OP('CSRRSI' , 0, X, X, 0b110, 0b11100, REG_WE | OPIMM | CSR_EN | CSR_IMM | CSR_BIT)
OP('CSRRCI' , 0, X, X, 0b111, 0b11100, REG_WE | OPIMM | CSR_EN | CSR_IMM | CSR_BIT | CSR_CLR)

...
OP('SYSTEM' , X, X, 0b000, 0b11100, FUNCT | SYSTEM)
...
OP('CSRRW'  , X, X, 0b001, 0b11100, 0)
OP('CSRRS'  , X, X, 0b010, 0b11100, 0)
OP('CSRRC'  , X, X, 0b011, 0b11100, 0)
OP('CSRRWI' , X, X, 0b101, 0b11100, 0)
OP('CSRRSI' , X, X, 0b110, 0b11100, 0)
OP('CSRRCI' , X, X, 0b111, 0b11100, 0)
